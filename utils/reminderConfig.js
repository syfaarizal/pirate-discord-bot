...
const DEFAULT_MESSAGES = {
  pagi: [
    ...
    "gm~ hari baru, versi lo yang baru juga",
    "morning~ gak harus sempurna hari ini, cukup jalan dulu",
    "gm gm! tarik napas… gas pelan-pelan",
    "morning~ start kecil hari ini > nunggu perfect",
    "yuk bangun, hidup masih nunggu di jalanin lho",
    "gm, sayang. pagi ini gak usah ngebut, asal gak berhenti",
    "morning! hari ini fresh start, jangan dibawa ya berat yang kemarin",
    "gm! kamu gak telat ko, kamu lagi di timing kamu sendiri",
    "good morning! ayo mulai, walau dikit",
    ...
    "gm~ hidup gak lomba kok, santai tapi tetep jalan",
    "pagi, sayangkuu~ satu progress kecil hari ini udah cukup kok",
    "morning! kalau mata udah kebuka, berarti ada kesempatan lagi, yuk manfaatin",
  ],
  siang: [
